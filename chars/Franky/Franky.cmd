...
[Command]
name = "Weapon Left"
command = ~B,DB,D,DF,F,c;F,DF,D,DB,B,b
time = 30
[Command]
name = "Weapon Left"
command = ~B,DB,D,DF,F+c;F,DF,D,DB,B+b
...
[Command]
name = "Beans Left"
command = ~D,DB,B,c;F,DF,D,DB,B,b
time = 30
[Command]
name = "Beans Left"
command = ~D,DB,B+c;F,DF,D,DB,B+b
...
[Command]
name = "Strong Hitter"
command = ~D,DB,B,b;F,DF,D,DB,B,b
time = 30
[Command]
name = "Strong Hitter"
command = ~D,DB,B+b;F,DF,D,DB,B+b
...
[Command]
name = "Strong Right"
command = ~D,DF,F,b;F,DF,D,DB,B,b
time = 30
[Command]
name = "Strong Right"
command = ~D,DF,F+b;F,DF,D,DB,B+b
...
;---------------------------------------------------------------------------
;Destroyer Hou
[State -1, Destroyer Hou]
type = ChangeState
value = 3300
triggerall = command = "Destroyer Hou"
...
trigger9 = (stateno = 1300) && (movecontact = 1)
trigger10 = (stateno = 1402) && (time > 16)
trigger11 = (stateno = 1700) && (time > 35)


;---------------------------------------------------------------------------
;Heavy Nunchaku
[State -1, Heavy Nunchaku]
type = ChangeState
value = 3200
triggerall = command = "Heavy Nunchaku"
triggerall = power >= 2000
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = (stateno = 200) && (time > 10)
...
;---------------------------------------------------------------------------
;Franky Kentauros
[State -1, Franky Kentauros]
type = ChangeState
value = 3100
triggerall = command = "Franky Kentauros"
...
;---------------------------------------------------------------------------
;Coup de Vent
[State -1, Coup de Vent]
type = ChangeState
value = 3000
triggerall = command = "Coup de Vent"
triggerall = power >= 1000
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = (stateno = 200) && (time > 10)
...
type = ChangeState
value = 1700
triggerall = command = "Weapon Left"
...
trigger7 = (stateno = 310) && (time > 10)
trigger8 = (stateno = 1100) && (time > 32)
trigger9 = (stateno = 1402) && (time > 16)


;---------------------------------------------------------------------------
;Beans Left - aire
[State -1, Beans Left - aire]
type = ChangeState
value = 1650
triggerall = command = "Beans Left"
triggerall = power > 100
trigger1 = statetype = A
trigger1 = ctrl
trigger2 = (stateno = 600) && (time > 10)
trigger3 = (stateno = 610) && (time > 12)
trigger4 = (stateno = 620) && (time > 18)
trigger5 = (stateno = [1210,1213]) && (time > 10)
...
trigger8 = (stateno = 1100) && (time > 32)
trigger9 = (stateno = 1402) && (time > 16)
trigger10 = (stateno = 1700) && (time > 35)



;---------------------------------------------------------------------------
;Strong Hitter
[State -1, Strong Hitter]
type = ChangeState
value = 1400
triggerall = command = "Strong Hitter"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = (stateno = 200) && (time > 10)
trigger3 = (stateno = 201) && (time > 8)
...
trigger6 = (stateno = 300) && (time > 11)
trigger7 = (stateno = 310) && (time > 10)
trigger8 = (stateno = 1300) && (movecontact = 1)


;---------------------------------------------------------------------------
;Strong Right
[State -1, Strong Right]
type = ChangeState
value = 1300
triggerall = command = "Strong Right"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = (stateno = 200) && (time > 10)
trigger3 = (stateno = 201) && (time > 8)
...
type = ChangeState
value = 1200
triggerall = command = "Coup de Poo"
...
;---------------------------------------------------------------------------
;Fresh Fire - Aire
[State -1, Fresh Fire - Aire]
type = ChangeState
value = 1150
triggerall = command = "Fresh Fire"
triggerall = power > 100
trigger1 = statetype = A
trigger1 = ctrl
trigger2 = (stateno = 600) && (time > 10)
...
trigger6 = (stateno = 300) && (time > 11)
trigger7 = (stateno = 310) && (time > 10)
trigger8 = (stateno = 1402) && (time > 16)
trigger9 = (stateno = 1700) && (time > 35)

;---------------------------------------------------------------------------
;Colas Chargue
[State -1, Colas Chargue]
type = ChangeState
value = 1000
triggerall = var(3) < 3
triggerall = command = "Colas Chargue"
trigger1 = statetype != A
trigger1 = ctrl
...
;Ouch Finger
[State -1, Diable Jamble mode Start]
type = ChangeState
value = 220
triggerall = var(2) != 1
triggerall = command = "c"
