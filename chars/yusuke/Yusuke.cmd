...
;-| Special Motions |------------------------------------------------------
[command]
name = "spiritgunmedium"
command = D,F,b
time = 15

[command]
name = "spiritgunheavy1"
command = D,B,c
time = 15
...
trigger1 = command = "charge4"
trigger1 = command = "charge 5"
trigger1 = statetype = S
trigger1=power > 0
;---------------------------------------------------------------------------
; Stand Light Kick
...
triggerall = command != "holddown"
triggerall = command != "holddown"
trigger1 = stateno = 889 && movehit
;---------------------------------------------------------------------------
; Standing Strong Kick
[State -1, spirit Gun standing medium]
type = ChangeState
value = 410
triggerall = var(0) != 78
triggerall = power> 1000
triggerall = command = "spiritgunmedium"
triggerall = command != "holddown"
trigger1 = statetype = S
trigger1 = ctrl
...
;---------------------------------------------------------------------------
; Standing Strong Kick
[State -1, spirit Gun standing Heavy]
type = ChangeState
value = 518
triggerall = var(0) != 78
triggerall = power> 2000
triggerall = command = "spiritgunheavy"
triggerall = command != "holddown"
trigger1 = statetype = S
trigger1 = ctrl
;---------------------------------------------------------------------------
...
;---------------------------------------------------------------------------
; Standing Strong Kick
[State -1, spirit Gun standing small]
type = ChangeState
value = 433
triggerall= power> 250
triggerall = command = "b"
