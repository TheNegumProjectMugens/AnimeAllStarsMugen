...
[Command]
name = "Lanzamiento de Poción de Veneno"
command = ~D,DB,B,a
time = 20
[Command]
name = "Lanzamiento de Poción de Veneno"
...
[Command]
name = "Lanzamiento de Poción explosiva"
command = ~D,DF,F,a
time = 20
[Command]
name = "Lanzamiento de Poción explosiva"
...
;---------------------------------------------------------------------------
;Monster Chopper
[State -1, Monster Chopper]
type = ChangeState
value = 3400
triggerall = command = "Monster Chopper"
...
trigger5 = (stateno = 2010) && (Movecontact = 1)
trigger6 = (stateno = 2020) && (Movecontact = 1)
trigger7 = (stateno = 2030) && (Movecontact = 1)


;---------------------------------------------------------------------------
;Roseo Michieri
[State -1, Roseo Michieri]
type = ChangeState
value = 3200
triggerall = var(2) = 1
triggerall = command = "Roseo Michieri"
...
trigger6 = (stateno = 2020) && (Movecontact = 1)
trigger7 = (stateno = 2030) && (Movecontact = 1)
trigger8 = (stateno = 2150) && (time >= 14)
trigger9 = (stateno = 2200)
trigger10 = (stateno = 2401) && (time >= 10)
...
trigger8 = (stateno = 320) && (Movecontact = 1)
...
;===================================================================================
;---------------- Specials  Rumble Mode ------------------------------------------
;===================================================================================


;---------------------------------------------------------------------------
;Defense Point - Aire
[State -1, Defense Point - Aire]
type = ChangeState
value = 2550
triggerall = var(2) = 1
triggerall = command = "Defense Point"
trigger1 = statetype = A
trigger1 = ctrl
...
trigger6 = (stateno = 2020) && (Movecontact = 1)
trigger7 = (stateno = 2030) && (Movecontact = 1)
trigger8 = (stateno = 2150) && (Movecontact = 1)
...
;---------------------------------------------------------------------------
;Roseo Daikyou
[State -1, Roseo Daikyou]
type = ChangeState
value = 2300
triggerall = var(2) = 1
triggerall = command = "Head Horn"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = (stateno = 200) && (Movecontact = 1)
trigger3 = (stateno = 201) && (Movecontact = 1)
...
value = 2250
triggerall = var(2) = 1
triggerall = command = "Kokutei Cross"
trigger1 = statetype = A
trigger1 = ctrl
trigger2 = (stateno = 600) && (Movecontact = 1)
trigger3 = (stateno = 610) && (Movecontact = 1)
...
type = ChangeState
value = 1500
triggerall = command = "Heavy Catch"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = (stateno = 200) && (Movecontact = 1)
trigger3 = (stateno = 201) && (Movecontact = 1)
...
;---------------------------------------------------------------------------
;Lanzamiento de Poción - aire
[State -1, Lanzamiento de Poción -aire]
type = ChangeState
value = 1110
triggerall = var(2) != 1
triggerall = numhelper(1050) = 0
triggerall = numhelper(1051) = 0
triggerall = command = "Lanzamiento de Poción explosiva"
trigger1 = statetype = A
trigger1 = ctrl
trigger2 = (stateno = 600) && (Movecontact = 1)
trigger3 = (stateno = 610) && (Movecontact = 1)
...
triggerall = command = "Lanzamiento de Poción de Veneno"
trigger1 = statetype = A
trigger1 = ctrl
trigger2 = (stateno = 600) && (Movecontact = 1)
trigger3 = (stateno = 610) && (Movecontact = 1)
...
;---------------------------------------------------------------------------
;Lanzamiento de Poción explosiva
[State -1, Lanzamiento de Poción explosiva]
type = ChangeState
value = 1010
triggerall = var(2) != 1
triggerall = numhelper(1050) = 0
...
;Arm Point - Roseo Diagonal
[State -1, Arm Point - Roseo Diagonal]
type = ChangeState
value = 2030
triggerall = Var(2) = 1
triggerall = command = "c"
