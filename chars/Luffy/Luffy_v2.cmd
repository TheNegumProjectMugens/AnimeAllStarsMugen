...
;---------------------------------------------------------------------------
;Giganto Bazzoka
[State -1, Giganto Bazzoka]
type = ChangeState
value = 3700
triggerall = command = "Giganto Bazzoka 1"
...
;---------------------------------------------------------------------------
;Giganto Jet Shell
[State -1, Giganto Jet Shell]
type = ChangeState
value = 3600
triggerall = var(2) = 1
triggerall = command = "Giganto Jet Shell"
...
value = 3400
triggerall = var(2) = 1
triggerall = command = "Jet Gatoringu Full"
triggerall = power >= 2000
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = (stateno = 201) && (movecontact = 1)
...
trigger13 = (stateno = 1401)
trigger14 = (stateno = [1510,1515]) && (time > 34)
...
;---------------------------------------------------------------------------
;Gatoringu - Gear Second
[State -1,  Gatoringu - Gear Second]
type = ChangeState
triggerall = var(2) = 1
value = 2500
...
trigger6 = (stateno = 2900) && (time > 16)

;---------------------------------------------------------------------------
;Jet Bazooka - En el aire
[State -1,  - Jet Bazooka - En el aire]
type = ChangeState
triggerall = var(2) = 1
triggerall = numhelper(2790) = 0
value = 2750
triggerall = command = "Bazooka"
trigger1 = statetype = A
trigger1 = ctrl
trigger2 = (stateno = 2300) && (movecontact = 1)
trigger3 = (stateno = 2310) && (movecontact = 1)
trigger4 = (stateno = 2320) && (movecontact = 1)
trigger5 = (stateno = 2330) && (movecontact = 1)
...
;---------------------------------------------------------------------------
;Jet Raifuru - Gear Second
[State -1,  - Gear Second]
type = ChangeState
triggerall = var(2) = 1
value = 2900
triggerall = command = "Raifuru"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = (stateno = 2201) && (movecontact = 1)
trigger3 = (stateno = 2210) && (movecontact = 1)
...
trigger7 = (stateno = 1200) && (time > 22)
trigger8 = (stateno = 1301) && (time > 7)
trigger9 = (stateno = 1302) && (time > 6)
trigger10 = (stateno = 1401)
trigger11 = (stateno = 1520) && (time > 10)

;---------------------------------------------------------------------------
;Gatoringu en el aire
[State -1, Gatoringu en el aire]
type = ChangeState
value = 1050
triggerall = var(2) != 1
triggerall = command = "Gatoringu en el aire" ;"Metralleta"
trigger1 = statetype = A
trigger1 = ctrl
trigger2 = (stateno = 601) && (movecontact = 1)
trigger3 = (stateno = 610) && (movecontact = 1)
trigger4 = (stateno = 620) && (movecontact = 1)
trigger5 = (stateno = 630) && (Time > 7)
...
trigger8 = (stateno = 223)
trigger9 = (stateno = 1020) && (Time > 12)
trigger10 = (stateno = 1301) && (time > 7)
trigger11 = (stateno = 1302) && (time > 6)
trigger12 = (stateno = 1401)
trigger13 = (stateno = 1520)
...
;---------------------------------------------------------------------------
;Fussen - En el aire
[State -1, Fussen - En el aire]
type = ChangeState
value = 1950
triggerall = var(2)!= 1
triggerall = command = "Fussen"
trigger1 = statetype = A
trigger1 = ctrl
...
;---------------------------------------------------------------------------
;Stand Light Atack - Buretto
[State -1, Stand Light Atack, Buretto]
type = ChangeState
value = 202
triggerall = command = "a"
